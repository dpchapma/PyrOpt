...
def define_protocols():
    ...
    for protocol_name, protocol_definition in protocol_definitions.items():
        ...
        # net_stimuli = []
        # for stimulus_definition in protocol_definition['net_stimuli']:
        #     net_stimuli.append(ephys.stimuli.NrnNetStimStimulus(
        #         total_duration=stimulus_definition['duration'],
        #         number = stimulus_definition['number'],
        #         interval = stimulus_definition['interval'],
        #         start = stimulus_definition['start'],
        #         weight = 5e-4,
